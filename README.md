...
```sh
  cd Recipe_App
  git clone https://github.com/harshitajain06/Recipe_App.git
```
...
Feel free to check the [issues page](https://github.com/harshitajain06/Recipe_App/issues/).
...
This project is [MIT](https://github.com/harshitajain06/Recipe_App/blob/dev/LICENSE) licensed.
